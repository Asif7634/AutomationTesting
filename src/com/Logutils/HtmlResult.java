...
import com.Application.DataProvider;
...
public class HtmlResult {
	...
	public HtmlResult()
	{
		try {
			...
			htmlStringBuilder.append("<html><head><title>Automation Test Report </title>");
			//append body
			...
			htmlStringBuilder.append("<table width =100%><tr>"
					+ "<td align=left widht=40%> <img src='"+ Path + "\\FrameWork\\Results\\ReportingImages\\viewicsLogo.png' align=left width='150' height='80'></td>"
					...
					+ "<td>"
					+ "<td align=right widht=40%><img src='"+ Path + "\\FrameWork\\Results\\ReportingImages\\rocheLogo.png' align=right width='105' height='80'></td>"
					+ "</tr></table>");
			//append table
			...
			htmlStringBuilder.append("<tr>"
					...
					+ "<td bgcolor=yellow width =12.5%><b> Application Type </b></td>"
					+ "<td><b> " + Market + "</b></td>"
			...
			TakeScreenShotsAfterPassingComponent = DataProvider.getValueFromExcel("TakeScreenShotsAfterPassingComponent");
	...
	public static void passedWithoutScreenshot(String strDescription, String strExpectedResult,String strActualResult)
	{
