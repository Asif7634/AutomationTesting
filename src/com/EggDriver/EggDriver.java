package com.EggDriver;


import java.awt.*;
import java.util.Map;

import com.EggDriver.EggDriveException;
...
public class EggDriver extends RpcConnector {
    ...
    {
    	try {
			executeString(formatter.reset().asCommand("PressHomeButton"));
    ...
    public Boolean imageFound(String imageName) throws EggDriveException {
        executeString(formatter.reset().addParameter(imageName).asFunction("ImageFound"));
        return (Boolean) getLastDriveResult().getReturnValue();
    }
    
    public void wait(int i) throws EggDriveException {
    	executeString(formatter.reset().addParameter(Integer.valueOf(i)).asCommand("Wait"));
    }
    ...
    public List<Point> everyTextLocation(String imageName) throws EggDriveException {
        executeString(formatter.reset().addParameter(imageName).asFunction("EveryImageLocation"));
        return getLastDriveResult().getReturnValueAsPoints();
    }
    
    public List<Point> textLocation(String imageName) throws EggDriveException {
        executeString(formatter.reset().addParameter(imageName).asFunction("ImageLocation"));
        return getLastDriveResult().getReturnValueAsPoints();
    }
    public List<Point> ImageLocation(String imageName) throws EggDriveException {
    	 executeString(formatter.reset().addParameter(imageName).asFunction("ImageLocation"));
    	  return getLastDriveResult().getReturnValueAsPoints();
    	  }
    public Boolean imageFound(int waitTime, String imageName) throws EggDriveException {
    	     executeString(formatter.reset().addParameter(Integer.valueOf(waitTime)).addParameter(imageName).asFunction("ImageFound"));
    	    return (Boolean)getLastDriveResult().getReturnValue();
      }
    
    public Boolean imageFound(String waitTime, String imageName) throws EggDriveException {
	     executeString(formatter.reset().addParameter(Integer.parseInt(waitTime)).addParameter(imageName).asFunction("ImageFound"));
	    return (Boolean)getLastDriveResult().getReturnValue();
 }
   
    public Boolean imageFound(String waitTime, String imageName,String SearchInRectangle) throws EggDriveException {
	     executeString(formatter.reset().addParameter(Integer.parseInt(waitTime)).addParameter(imageName).addParameter(SearchInRectangle).asFunction("ImageFound"));
	    return (Boolean)getLastDriveResult().getReturnValue();
    }
	    
	    
    public Boolean imageFound(int waitTime, String imageName,String SearchInRectangle) throws EggDriveException {
	     executeString(formatter.reset().addParameter(Integer.valueOf(waitTime)).addParameter(imageName).addParameter(SearchInRectangle).asFunction("ImageFound"));
	    return (Boolean)getLastDriveResult().getReturnValue();
 }
    //endregion
    ...
    public String readText(Rectangle r, String ValidWords) throws EggDriveException
    {
    	executeString(formatter.reset().addParameter(r).addParameter(ValidWords).addPListParameters(textSearchOptions).asFunction("ReadText"));
    ...
    public void clickImage(String image) throws EggDriveException {
    	executeString(formatter.reset().addParameter(image).asCommand("Click"));
    }
    //end region
    
    //region user defined
    //********************************************************************************
    public void captureScreen(String ImageName) throws EggDriveException
    {	 
    	executeString(formatter.reset().addQuotedPListParameter("Name", ImageName).asCommand("CaptureScreen"));
    }
    public String colouratlocation(String Text) throws EggDriveException {
    	     executeString(formatter.reset().addParameter(Text).asFunction("ColorAtLocation"));
    	    return (String)getLastDriveResult().getReturnValue();
    	   }
    public void setValue(String variableName, String value) throws EggDriveException
    {
    	executeString(formatter.reset().asCommand("set " + variableName + " to " + value));
    }
    public void setSearchRectangle(String Rectangle) throws EggDriveException
    {
    	executeString(formatter.reset().addParameter(Rectangle).asCommand("set the SearchRectangle to"));
    }
    
    public List<Point> getLocation() throws EggDriveException
    {
    	executeString(formatter.reset().asFunction("foundimagelocation"));
    	return getLastDriveResult().getReturnValueAsPoints();
    }
    
    public List<Map<String, Object>> textInfo(String imageName) throws EggDriveException {
        executeString(formatter.reset().addParameter(imageName).asFunction("ImageInfo"));
        return getLastDriveResult().getReturnValueAsPLists();
    }

    public void CaptureScreen(String imageName1) throws EggDriveException {
    	executeString(formatter.reset().addParameter(imageName1).asCommand("CaptureScreen"));
    }
}
